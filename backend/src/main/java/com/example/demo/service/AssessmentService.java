...
public class AssessmentService {
    ...
    public List<Assessment> getAssessmentsByUserAndCourse(Users users, Course course) {
        return assessmentRepository.findByUserAndCourse(users, course);
    }
    
    public ResponseEntity<List<Assessment>> getAssessmentByUser(Users users){
    	return ResponseEntity.status(HttpStatus.CREATED).body(assessmentRepository.findByUser(users));
    }
    ...
    public ResponseEntity<Assessment> saveAssessment(Users users, Course course, Assessment assessment) {
        List<Assessment> existingAssessments = getAssessmentsByUserAndCourse(users, course);
